...
import { LayoutDashboard, Users, GraduationCap, BookOpen, Calendar, CreditCard, Brain, LogOut, Shield } from "lucide-react";
...
export function AdminLayout() {
  ...
  const navItems = [
    ...
    { to: "/admin/tutors", icon: GraduationCap, label: "Tutores" },
    { to: "/admin/subjects", icon: BookOpen, label: "Materias" },
    { to: "/admin/sessions", icon: Calendar, label: "Sesiones" },
    { to: "/admin/payments", icon: CreditCard, label: "Pagos" },
    { to: "/admin/ai-logs", icon: Brain, label: "Logs IA" },
  ];
        ...
        <div className="px-5 py-5 mb-1">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-600 leading-none mt-1">Administrador</p>
            </div>
          </div>
        </div>
